...
boolean suppress_serial_logging = false;    // Stop user from setting serial logging in WebUI
...
void setup(void)
{
  ...
  suppress_serial_logging = false;   // Initialize serial logging suppresion
